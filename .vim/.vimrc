...
set tabstop=2 " ustawia wielkosc <Tab> w spacjach
set shiftwidth=2 " ilosc spacji uzyta jako wciecie
set softtabstop=2
...
" {{{ [ c, c++ ]
autocmd FileType c,cpp,h,hpp set cindent formatoptions=croql comments=sr:/*,mb:*,ex:*/,://
